...
function MailSmtp($reciever, $subject, $content, $headers, $debug = 0) {
  ...
  $smtp_user = 'www@avtohels.ru'; // Имя пользователя для авторизации на SMTP-сервере
  $smtp_password = 'fa4bHxDuc'; // Пароль для авторизации на SMTP-сервере
  $mail_from = 'www@avtohels.ru'; // Ящик, с которого отправляется письмо
